...
function BannerWidget( template, config ) {
	...
	if ( this.isShellTemplate ) {
		...
		const shellClassParam = template.parameters.find( ( parameter ) => parameter.name === 'class' );
		...
		const classParam = template.parameters.find( ( parameter ) => parameter.name === 'class' );
	...
	if ( this.hasImportanceRatings ) {
		...
		const importanceParam = template.parameters.find( ( parameter ) => parameter.name === 'importance' );
